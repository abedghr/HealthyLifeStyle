	...
	<header class="header-area main-header">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2">
                    <div class="logo-area">
                        <a href="index.php"><img src="assets/images/logo1.jpeg" alt="logo" width= 150px height=60px style="margin-top:15px"></a>
                    </div>
                </div>
                <div class="col-lg-10">
				...
				<a href="profile.php"><i class="fa fa-user-circle-o fa-3x " aria-hidden="true"></i></a></i>
                            <li class="menu-btn" style="margin-left: 10px">
